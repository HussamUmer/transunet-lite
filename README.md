...
## 3. Experimental Setup (Shared for All Models)
...
## 5. Full GPU Test Results

### 5.1 Dice & IoU (Higher is Better)
...
### 5.2 AUPRC & AUROC (Higher is Better)
...
### 5.3 Inference Latency on GPU (Lower is Better)
...
### 5.4 Peak VRAM on GPU (Lower is Better)
...
## 6. CPU-Only Evaluation (Realistic Edge Scenario)
...
### 6.2 Latency Distribution on CPU (Lower is Better)
...
### 6.3 Throughput (Frames per Second, Higher is Better)
...
### 6.4 Peak RAM on CPU (Lower is Better)
...
## 7. What Do These Results Tell Us?
...
## 8. Objectives of This Repository
